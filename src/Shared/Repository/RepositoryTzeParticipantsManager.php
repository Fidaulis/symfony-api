...
class RepositoryTzeParticipantsManager
{
    ...
    /**
     * @param SkMatiere $_participants
     * @param $_action
     *
     * @return bool
     */
    public function saveTzeParticipants(SkMatiere $_participants, $_action)
    {
        if ('new' == $_action) {
     ...
     * @param $_image
     */
    public function addImage(SkMatiere $_participants, $_image)
    {
     ...
     * @return array
     */
    public function deleteImage(SkMatiere $_participants)
    {
        if ($_participants) {
            try {
     ...
     * @return array
     */
    public function deleteOnlyImage(SkMatiere $_participants)
    {
        if ($_participants) {
            $_path = $this->_web_root.$_participants->getPartImage();
